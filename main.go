...
import (
	...
	"github.com/uacademy/blogpost/article_service/docs" // docs is generated by Swag CLI, you have to import it.
	"github.com/uacademy/blogpost/article_service/handlers"
...
func initGRPC(){
	...
	s := grpc.NewServer()
	articleproto.RegisterArticleServiceServer(s, &article.ArticleService{})
	authorproto.RegisterAuthorServiceServer(s,&author.AuthorService{})
